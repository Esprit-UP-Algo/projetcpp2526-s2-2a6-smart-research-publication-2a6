...
public:
    ...
    bool      update(const BioSample& s, const QString& oldRef = QString());
    ...
    int                           totalCount();
    QMap<QString, int>            countByTemperature();
    QVector<QPair<QString, int>>  topByQuantity(int n = 8);
    QString                       topTemperature();
    QString                       topReference();
    int                           countThisMonth();
