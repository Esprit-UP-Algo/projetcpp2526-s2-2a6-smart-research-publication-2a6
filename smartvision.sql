...
CREATE TABLE APP_USERS (
  ...
  CONSTRAINT CK_USERS_ACTIVE CHECK (ACTIVE IN ('O','N'))
);

INSERT INTO APP_USERS (EMAIL, USER_PASSWORD, FULL_NAME, ROLE, ACTIVE)
VALUES ('admin@smartvision.tn', 'admin123', 'Administrateur SmartVision', 'ADMIN', 'O');
